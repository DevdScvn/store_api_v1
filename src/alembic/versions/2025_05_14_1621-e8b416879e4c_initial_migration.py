...
Revision ID: e8b416879e4c
Revises: 
Create Date: 2025-05-14 16:21:33.108023
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('in_progress', 'delivered', 'sent', name='orderstatus'), nullable=False),
